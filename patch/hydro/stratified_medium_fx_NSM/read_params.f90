subroutine read_params
  ...
  namelist/cc_params/medium_type,grid_file,random_file,rc,xwind,ywind,zwind & 
       & ,rhocool,Pc,vin,Mdot_in,Tin_K,logLAGN,alph,r0,h,gam,E_SN_th &
       & ,P_SN_rad,E_SN_kin,sn_rate,nblast_current, Ia_vs_NSM, conversion_NSM, conversion_Ia, t_delay_NSM, t_delay_Ia, H_NSM, H_Ia
