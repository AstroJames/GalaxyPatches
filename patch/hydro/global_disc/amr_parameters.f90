module amr_parameters
  ...
  ! Davide Martizzi
  !Parameters of the global disc model not related to the potential
  real(dp)::rho0gas=1.66D-22      ! Central gas density in cgs
  real(dp)::rhoamb=1.66D-32       ! Ambient density in cgs 
  real(dp)::Tmu0gas=1.3D4           ! Temperature of the disc
