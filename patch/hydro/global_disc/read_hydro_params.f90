subroutine read_hydro_params(nml_ok)
  ...
  ! Hydro parameters
  namelist/hydro_params/gamma,courant_factor,smallr,smallc,cceil & ! Davide Martizzi added ceiling
  ...
  namelist/feedback_params/eta_sn,eta_ssn,yield,rbubble,f_ek,ndebris &
       & ,f_w,mass_gmc,kappa_IR,delayed_cooling,momentum_feedback,adaptive_feedback &
       & ,ir_feedback,ir_eff,t_diss,t_sne,mass_star_max,mass_sne_min

  ! Cooling / basic chemistry parameters
  namelist/cooling_params/cooling,peh_heat,metal,isothermal,haardt_madau,J21 &
